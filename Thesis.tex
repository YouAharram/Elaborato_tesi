...
%--------------------------------------------------------------
\newcommand{\myItalianTitle}{METODI DI APPRENDIMENTO AUTOMATICO PER LA FUSIONE DI IMMAGINI SAR DESPECKLED\xspace}
\newcommand{\myEnglishTitle}{Machine Learning Methods for the Fusion of Despeckled SAR Images\xspace}
...
\include{Chapters/03-UnetMethod}
\include{Chapters/04-AttentionMethod}
\include{Chapters/05-ConfrontoMetodi}
